...
export class LoginComponent implements OnInit {
  ...
  constructor(private auth: AuthService, private router: Router, private route: ActivatedRoute, private snack: MatSnackBar, private _fb: FormBuilder, private userService: UserService) {
    this.errors = {};
  }
  ngOnInit() {
